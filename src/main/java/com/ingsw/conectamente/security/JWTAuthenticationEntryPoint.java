...
import com.ingsw.conectamente.exception.CustomErrorResponse;
...
public class JWTAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    private String convertObjectToJson(Object object) throws JsonProcessingException {
            ...
            mapper.findAndRegisterModules(); // Esto registra modulos adicionales i es necesario (por ejemplo, soporte de fechas)
